...
<body>
      <h2>Cập nhật giáo viên</h2>
       ...
       <form class= "form" action="../editgiaovien/<?php  $dataID = $data["data"]; echo $dataID["id_gv"]?>" method="POST">
              ...
              <div class="form-right">
                 ...
                 <input style="margin-top: 20px;"class="button" type="submit" name="edit" value="Cập nhật">
              </div>          
       </form>
